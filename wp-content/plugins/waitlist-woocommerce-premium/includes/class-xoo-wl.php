...
class Xoo_Wl{
	...
	public function defining_constants(){
		...
		$this->define( "XOO_WL_VERSION", "3.0" ); //Plugin version
		$this->define( "XOO_WL_PRO", true );
	}
	...
	*/
	public function on_install(){
		...
		if( !$db_version ){
			...
			if( get_option( 'xoo-wl-gl-enguest' ) !== false ){
				$this->fetch_old_plugin_settings();
				wp_schedule_single_event( time() + 3, 'xoo_wl_cron_fetch_old_waitlist' );
			}
