...
class Xoo_Wl_Emails{
	...
	public function __construct(){
		...
		$this->adminNotify 		= include XOO_WL_PATH.'includes/emails/class-xoo-wl-admin-notify-email.php';
		$this->userNotify 		= include XOO_WL_PATH.'includes/emails/class-xoo-wl-user-notify-email.php';
		$this->hooks();
	}
	...
	public function hooks(){
		...
		add_action( 'xoo_wl_email_footer', array( $this, 'email_footer' ), 50 );
