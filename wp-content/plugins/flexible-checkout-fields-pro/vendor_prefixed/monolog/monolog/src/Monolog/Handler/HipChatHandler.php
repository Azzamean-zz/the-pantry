 ...
 */
class HipChatHandler extends \FCFProVendor\Monolog\Handler\SocketHandler
{
    /**
     * Use API version 1
     */
     ...
     */
    public function __construct($token, $room, $name = 'Monolog', $notify = \false, $level = \FCFProVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $format = 'text', $host = 'api.hipchat.com', $version = self::API_V1)
    {
    ...
    {
        switch (\true) {
            case $level >= \FCFProVendor\Monolog\Logger::ERROR:
                return 'red';
            case $level >= \FCFProVendor\Monolog\Logger::WARNING:
                return 'yellow';
            case $level >= \FCFProVendor\Monolog\Logger::INFO:
                return 'green';
            case $level == \FCFProVendor\Monolog\Logger::DEBUG:
                return 'gray';
            default:
                return 'yellow';
        }
