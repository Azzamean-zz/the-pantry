...
<div>
	...
	<input type="number" id="option_<?php echo $name ?>" name="inspire_checkout_fields[settings][<?php echo $key ?>][<?php echo $name ?>][days_before]" value="<?php echo isset($settings[$key][$name]['days_before'])?$settings[$key][$name]['days_before']:'0'; ?>"  class="field_days_before" data-qa-id="field-days-before" />
...
<div>
	...
	<input type="number" id="option_<?php echo $name ?>" name="inspire_checkout_fields[settings][<?php echo $key ?>][<?php echo $name ?>][days_after]" value="<?php echo isset($settings[$key][$name]['days_after'])?$settings[$key][$name]['days_after']:''; ?>"  class="field_days_after" data-qa-id="field-days-after" />
