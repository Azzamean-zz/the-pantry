...
html += '<input type="number" id="option_' + field_slug + '" name="inspire_checkout_fields[settings]['+ field_section +'][' + field_slug + '][days_before]" value="" class="field_days_before" data-qa-id="field-days-before" />';
...
html += '<input type="number" id="option_' + field_slug + '" name="inspire_checkout_fields[settings]['+ field_section +'][' + field_slug + '][days_after]" value="" class="field_days_after" data-qa-id="field-days-after" />';
html += '<p class="description"><?php _e( 'Leave blank for unlimited', 'flexible-checkout-fields-pro' ) ?></p>';
html += '</div>';
