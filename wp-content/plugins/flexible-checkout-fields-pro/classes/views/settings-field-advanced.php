...
<div class="field-settings-tab-container field-settings-advanced" style="display:none;">
	<div>
		...
		<label>
			...
			<?php  echo __( 'Enable Product/Category Conditional Logic', 'flexible-checkout-fields-pro' ) ?>
		</label>
	</div>
	<?php
	...
	<div class="conditional-logic-fields" <?php echo $style; ?>>
		<div class="options">
			...
			<select data-qa-id="field-conditional-logic-operator-product" name="inspire_checkout_fields[settings][<?php echo $key ?>][<?php echo $name ?>][conditional_logic_operator]">
				...
				?>
				<option value="and" <?php echo $selected; ?>><?php echo __( 'All rules match (and)', 'flexible-checkout-fields-pro' ); ?></option>
				<?php
				$selected = '';
		...
		<div class="rules">
					...
					<div class="rule">
						<fieldset>
							...
							<div class="condition">
								<div>
									<select data-qa-id="field-conditional-logic-rules-condition" name="inspire_checkout_fields[settings][<?php echo $key ?>][<?php echo $name ?>][conditional_logic_rules][<?php echo $count; ?>][condition]">
										...
										?>
										<option value="cart_contains" <?php echo $selected; ?>><?php echo __( 'Cart contains', 'flexible-checkout-fields-pro' ); ?></option>
									</select>
								</div>
							</div>
							<div class="what">
								<div>
									<select data-qa-id="field-conditional-logic-rules-what" class="what" name="inspire_checkout_fields[settings][<?php echo $key ?>][<?php echo $name ?>][conditional_logic_rules][<?php echo $count; ?>][what]">
										...
										?>
										<option value="product" <?php echo $selected; ?>><?php echo __( 'Product', 'flexible-checkout-fields-pro' ); ?></option>
										<?php
										$selected = '';
										...
										?>
										<option value="product_category" <?php echo $selected; ?>><?php echo __( 'Product Category', 'flexible-checkout-fields-pro' ); ?></option>
									</select>
								</div>
							</div>
							<?php
							...
							<div class="products" <?php echo $style; ?>>
								<div>
									<select
										...
										data-sortable="true"
										data-placeholder="<?php echo __( 'Select products', 'flexible-checkout-fields-pro' ); ?>"
							...
							<div class="product_categories" <?php echo $style; ?>>
								<div>
									<input type="hidden" placeholder="<?php echo __( 'Select categories', 'flexible-checkout-fields-pro' ); ?>" class="categories-select2" multiple="multiple" name="inspire_checkout_fields[settings][<?php echo $key ?>][<?php echo $name ?>][conditional_logic_rules][<?php echo $count; ?>][product_categories]" value="<?php echo $rule['product_categories']; ?>">
								</div>
							</div>
			...
			<div class="add_rule_button">
				<a class="button add_rule_button" href="#add_rule" data-count="<?php echo $count; ?>" data-key="<?php echo $key; ?>" data-name="<?php echo $name; ?>"><?php echo __( 'Add rule', 'flexible-checkout-fields-pro' ); ?></a>
			</div>
		</div>
    ...
    <div>
        ...
        <label>
            ...
            <?php  echo __( 'Enable Fields Conditional Logic', 'flexible-checkout-fields-pro' ) ?>
        </label>
    </div>
    <?php
    $style = 'style="display:none;"';
    ...
    <div class="conditional-logic-fields-fields" <?php echo $style; ?>>
        ...
        <div class="rules">
                            ...
                            <div class="field">
                                <div>
                                    <select data-qa-id="field-conditional-logic-fields-rules-field" name="inspire_checkout_fields[settings][<?php echo $key ?>][<?php echo $name ?>][conditional_logic_fields_rules][<?php echo $count; ?>][field]">
                                        ...
                                        <option <?php echo $selected; ?> value="" disabled><?php echo __( 'Select field', 'flexible-checkout-fields-pro' ); ?></option>
                            ...
                            <div class="condition">
                                <div>
                                    <select data-qa-id="field-conditional-logic-fields-rules-condition" class="what" name="inspire_checkout_fields[settings][<?php echo $key ?>][<?php echo $name ?>][conditional_logic_fields_rules][<?php echo $count; ?>][condition]">
                                        ...
                                        <option value="is" <?php echo $selected; ?>><?php echo __( 'is', 'flexible-checkout-fields-pro' ); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="value">
                                <div>
                                    <select data-qa-id="field-conditional-logic-fields-rules-value" name="inspire_checkout_fields[settings][<?php echo $key ?>][<?php echo $name ?>][conditional_logic_fields_rules][<?php echo $count; ?>][value]">
	                                    ...
	                                    <?php if ( isset( $rule['field'] ) && isset( $flexible_checkout_fields_all_field_values[$rule['field']] ) ) : ?>
		                                    ...
		                                    <?php endforeach; ?>
	                                    <?php endif; ?>
                                        <option value="" <?php echo $selected; ?> disabled><?php echo __( 'Select value', 'flexible-checkout-fields-pro' ); ?></option>
                                        <?php if ( isset( $rule['field'] ) && isset( $flexible_checkout_fields_all_field_values[$rule['field']] ) ) : ?>
                                            <?php foreach ( $flexible_checkout_fields_all_field_values[$rule['field']] as $option_key => $option_value ) : ?>
                                                <?php $selected = ''; ?>
            ...
            <?php $count++; ?>
            <div class="add_rule_button">
                <a class="button add_rule_fields_button" href="#add_rule" data-count="<?php echo $count; ?>" data-key="<?php echo $key; ?>" data-name="<?php echo $name; ?>"><?php echo __( 'Add rule', 'flexible-checkout-fields-pro' ); ?></a>
            </div>
        </div>
    </div>


	<!--Conditional logic shipping fields start-->
		<?php include ( __DIR__ . '/shipping-conditional-logic/shipping-conditional-logic.php' ); ?>
	<!--Conditional logic fields end-->
	<?php $read_more_link    = get_locale() === 'pl_PL' ? 'https://www.wpdesk.pl/docs/woocommerce-checkout-fields-docs/#Logika_warunkowa' : 'https://www.wpdesk.net/docs/flexible-checkout-fields-pro-woocommerce-docs/#Conditional_Logic'; ?>
	<div class="info"><p><small><?php echo sprintf(__('When you use many types of logic, the priority will be set by order as above. <a href="%s" target="_blank">Read more →</a>', 'flexible-checkout-fields-pro'), esc_url( $read_more_link )) ?></small></p></div>
</div>
