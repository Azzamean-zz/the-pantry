 ...
 */
class Flexible_Checkout_Fields_Pro_Field_Type
	implements \FCFProVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant {
	 ...
	 * @param \FCFProVendor\WPDesk\View\Renderer\Renderer $renderer Renderer.
	 */
	public function __construct( $checkout_fields_pro, FCFProVendor\WPDesk\View\Renderer\Renderer $renderer ) {
