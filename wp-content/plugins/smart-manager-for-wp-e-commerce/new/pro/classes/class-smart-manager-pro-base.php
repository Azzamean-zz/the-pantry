...
if ( ! class_exists( 'Smart_Manager_Pro_Base' ) ) {
	class Smart_Manager_Pro_Base extends Smart_Manager_Base {
		...
		public function batch_update() {
			...
			$this->send_to_background_process( array( 'process_name' => 'Batch Update', 
		...
		public function get_print_invoice() {
			...
			ob_start();
			include( apply_filters( 'sm_beta_pro_batch_order_invoice_template', SM_BETA_PRO_URL.'templates/order-invoice.php' ) );
			echo ob_get_clean();
			exit;
		}
