...
if ( ! class_exists( 'Smart_Manager_Pro_Product' ) ) {
	class Smart_Manager_Pro_Product extends Smart_Manager_Pro_Base {
		...
		function __construct($dashboard_key) {
			...
			if ( file_exists(SM_BETA_URL . 'classes/class-smart-manager-product.php') ) {
				include_once SM_BETA_URL . 'classes/class-smart-manager-product.php';
			...
			foreach( $column_model as $key => &$column ) {
				...
				switch( $col_nm ) {
					...
					case '_product_addons':
						$column['editor_schema'] = file_get_contents( SM_PLUGIN_DIR_PATH . '/new/pro/assets/js/json-schema/product-addons.json' );
						break;
