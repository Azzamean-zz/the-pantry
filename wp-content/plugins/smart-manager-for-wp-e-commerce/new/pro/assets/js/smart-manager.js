...
jQuery(document).on('smart_manager_init','#sm_editor_grid', function() {
    ...
    window.smart_manager.sm_beta_smart_date_filter = '<div class="sm_date_range_container">'+
                                                            ...
                                                            '<div class="sm_beta_right dropdown">'+
                                                                ...
                                                                '<ul class="dropdown-menu pull-left" aria-labelledby="smartDatesDropdown">'+
...
Smart_Manager.prototype.processBatchUpdate = function() {
    ...
    setTimeout( function() { 
            window.smart_manager.showProgressDialog('Batch Update'); 
        ...
        jQuery(document).on('change','.batch_update_action',function(){
            ...
            if( selected_action == 'copy_from' ) {
                ...
                let select2Params = {
                    ...
                    placeholder: 'Select '+window.smart_manager.dashboard_display_title,
