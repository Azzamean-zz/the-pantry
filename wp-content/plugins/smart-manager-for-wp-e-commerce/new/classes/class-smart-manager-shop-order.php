			...
			if( !empty( $order_id_cond ) ) {
	            ...
	            if ( count( $variation_ids ) > 0 ) {
	            	...
	            	if( count( $variation_ids ) > 100 ) {
						...
						$variation_id_cond = " AND FIND_IN_SET ( postmeta.post_id, ( SELECT option_value FROM {$wpdb->prefix}options WHERE option_name = 'sm_beta_export_".$dashboard."_variation_ids' ) ) ";
					} else {
