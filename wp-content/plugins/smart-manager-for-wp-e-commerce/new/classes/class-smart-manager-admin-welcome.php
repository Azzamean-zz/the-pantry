...
class Smart_Manager_Admin_Welcome {
	...
	function smart_manager_support_ticket_content() {
		...
		StoreApps_Upgrade_3_6::support_ticket_content( self::$prefix, self::$sku, $plugin_data, $license_key, 'smart-manager-for-wp-e-commerce' );
	}
	...
	private function intro() {
		...
		if( function_exists( 'smart_manager_get_version' ) ) {
			$version = smart_manager_get_version();
		}
