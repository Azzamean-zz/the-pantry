...
if ( ! class_exists( 'Pie_WCWL_Waitlist_Joined_Email' ) ) {
	 ...
	 *
	 * @class    Pie_WCWL_Waitlist_Joined_Email
	 * @extends  WC_Email
	 */
		...
		public function get_content_html() {
			...
			wc_get_template(
				...
				array(
					...
					'key'           => hash_hmac( 'sha256', $this->recipient . '|' . $product_id, get_the_guid( $product_id ) . $this->recipient . 'woocommerce-waitlist' ),
				),
				false,
				$this->template_base
			);
		...
		public function get_content_plain() {
			...
			wc_get_template(
				...
				array(
					...
					'product_id'    => $product_id,
					'email'         => $this->recipient,
					'key'           => hash_hmac( 'sha256', $this->recipient . '|' . $product_id, get_the_guid( $product_id ) ),
				),
				false,
				$this->template_base
			);
