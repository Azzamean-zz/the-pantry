        ...
        public static function get_event_fields() {
            ...
            $default_fields = array(
                ...
                array(
                    ...
                    'tooltip' => 'Specify the ticket quantity limitation. If Per ticket type is selected, the number of available tickets will be defiined within each ticket ticket. If Per event is selected, you can specify the number of available tickets for this event that will be applied to all the ticket types for this event combined.',
                    'table_visibility' => false,
                    'post_field_type' => 'post_meta',
                    'show_in_post_type' => true
                ),
